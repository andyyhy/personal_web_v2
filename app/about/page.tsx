export default function About() {
  return (
    <div className="min-h-screen p-4 sm:p-6 md:p-8 text-gray-500">
      <div className="max-w-4xl w-full mx-auto p-4 sm:p-6 md:p-8">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-outside leading-7 mt-4 sm:mt-6 pl-5">
            ...
            <li className="mb-2">Leading a team to do a redesign of the <a href="https://sanxi.com" className="text-[#8BC34A] hover:underline" target="_blank" rel="noopener noreferrer">sanxi.com</a> website</li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-outside leading-7 mt-4 sm:mt-6 pl-5">
            ...
            <li className="mb-2">2016: Wrote my first line of code in <a href="https://scratch.mit.edu/" className="text-[#8BC34A] hover:underline" target="_blank" rel="noopener noreferrer">Scratch</a> </li>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-outside leading-7 mt-4 sm:mt-6 pl-5">
            <li className="mb-2">
              Email: <a href="mailto:andyyhyang@gmail.com" className="text-[#8BC34A] hover:underline" target="_blank" rel="noopener noreferrer">andyyhyang@gmail.com</a>
            </li>
            <li className="mb-2">
              LinkedIn: <a href="https://www.linkedin.com/in/andyyhy" className="text-[#8BC34A] hover:underline" target="_blank" rel="noopener noreferrer">linkedin.com/in/andyyhy</a>
            </li>
            <li className="mb-2">
              Instagram: <a href="https://www.instagram.com/andyyhy02/" className="text-[#8BC34A] hover:underline" target="_blank" rel="noopener noreferrer">https://www.instagram.com/andyyhy02/</a>
            </li>
            <li className="mb-2">
              GitHub: <a href="https://github.com/andyyhy" className="text-[#8BC34A] hover:underline" target="_blank" rel="noopener noreferrer">github.com/andyyhy</a>
            </li>
          </ul>
        </section>
      </div>
