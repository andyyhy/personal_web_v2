    ...
    <html lang="en">
      ...
      <body>
        <div className="w-full border-b border-zinc-800 px-4 sm:px-6 md:px-8">
          <div className="w-full mx-auto py-4 px-2 sm:px-4 md:px-6 flex flex-row justify-between items-center">
              ...
              <NavigationMenuList className="flex space-x-4 md:space-x-8">
                ...
                <NavigationMenuItem>
                  <Link href="/projects" legacyBehavior passHref>
                    <NavigationMenuLink
                      className={`${navigationMenuTriggerStyle()} hover:bg-[#8BC34A]`}
                    >
                      Projects
                    </NavigationMenuLink>
                  </Link>
        ...
        <footer>
          <div className="max-w-4xl w-full mx-auto p-4 sm:p-6 md:p-8 flex flex-col items-center space-y-4">
            <div className="flex flex-row space-x-4 lg:fixed lg:bottom-6 lg:left-6 lg:flex-col lg:space-y-4 lg:space-x-0">
              <Link
                href="mailto:andyyhyang@gmail.com"
                target="_blank"
              ...
              <Link
                href="https://www.linkedin.com/in/andyyhy"
                target="_blank"
                rel="noopener noreferrer"
                passHref
              >
                <svg
                  className="h-6 w-6 text-gray-500 hover:text-[#8BC34A] transition-colors duration-200"
              ...
              <Link
                href="https://www.instagram.com/andyyhy02/"
                target="_blank"
                rel="noopener noreferrer"
                passHref
              >
            ...
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} Andy Yu Han Yang. All rights
              reserved.
            </p>
          </div>
        </footer>
